                    ...
                    <div class="deals clearfix">
                        ...
                        @foreach ($homestayrestore as $Homestay)
                            <article class="one-fourth homestay-custom">
                                <figure><a title=""><img src="{{ asset('public/' . $Homestay->avatar) }}" alt="" width="270"
                                            height="152" /></a></figure>
                                <div class="details custom_details">
                                    ...
                                    <a href="{{ route('Restore_homestay', ['id' => $Homestay->id]) }}" title="Xóa"
                                        class="custom-button danger "
                                        onclick="return confirm('Bạn muốn khôi phục Homestay ?')">Khôi phục Homestay</a>
                                </div>
                            </article>
                            <!--//deal-->
                        @endforeach
