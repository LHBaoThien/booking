        ...
        <div class="wrap clearfix">
          ...
          <li><a href="#" title="Change search">Change search</a></li>
                ...
                <section class="three-fourth form-booking">
                    <h1 style="text-align: center;text-transform: uppercase;">Ảnh của Homestay <br><b
                            style="color: lightcoral;font-size:15px"><u>{{ $homestay->name }}</u></b></h1>
                    ...
                    <form id="booking" method="post" action="" class="booking ">
                        ...
                        @foreach ($homestay->image as $imageval)
                            ...
                            <article class="one-fourth img_custom">
                                ...
                                <div class="details">
                                    <a href="{{ route('delete_image', ['id' => $imageval->id]) }}"
                                        onclick="return confirm ('Bạn có muốn xóa ảnh')">
                                        <img style="float: right" src="{{ URL::to('/') }}/partner/images/ico/delete1.png"
                        ...
                        @if (empty($homestay->avatar == ''))
                            <article class="one-fourth img_custom">
                                ...
                                <div class="details">
                                    <a href="{{ route('delete_avatar_homestay', ['id' => $homestay->id]) }}"
                                        onclick="return confirm ('Bạn có muốn xóa ảnh')">
                                        <img style="float: right" src="{{ URL::to('/') }}/partner/images/ico/delete1.png"
