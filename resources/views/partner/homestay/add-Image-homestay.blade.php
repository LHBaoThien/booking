					...
					<form id="booking" method="post" action="" class="booking " >
						...
						<!--get inspired list-->
							...
							<article class="one-fourth img_custom">
								<figure>
									<img src="{{asset($imageval->url)}}" alt="" width="270" height="152">
								</figure>
								<div class="details">
									<h5>{{$homestay->name}}</h5>
								</div>
								<div class="details">
									<a href="{{route('delete_image', ['id'=>$imageval->id])}}"  onclick="return confirm ('Bạn có muốn xóa ảnh')">
                                        <img style="float: right" src="{{ URL::to('/') }}/partner/images/ico/delete1.png" alt="" width="20" height="20" />
                                    </a>
								</div>
							</article>
							@endforeach
							...
							<article class="one-fourth img_custom">
								<figure>
									<img src="{{asset($homestay->avatar)}}" alt="" width="270" height="152">
								</figure>
								<div class="details">
									<h5>Avatar Homestay</h5>
								</div>
								<div class="details">
									<a href="{{route('delete_avatar_homestay', ['id'=>$homestay->id])}}"  onclick="return confirm ('Bạn có muốn xóa ảnh')">
                                        <img style="float: right" src="{{ URL::to('/') }}/partner/images/ico/delete1.png" alt="image" width="20" height="20" />
                                    </a>
								</div>
							</article>
							@endif
