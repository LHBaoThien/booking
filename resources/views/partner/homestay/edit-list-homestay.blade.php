        ...
        <div class="wrap clearfix">
            ...
            <div class="content clearfix">
                ...
                <section class="three-fourth form-booking">
                    <h1 style="text-align: center;text-transform: uppercase;">Sửa thông tin homestay <br><br><b
                            style="color: lightcoral"><u>{{ $homestay->name }}</u></b> </h1>
                                ...
                                <div class="f-item custom-item">
                                    <label>Mô tả Homestay :
                                        <textarea rows="10" cols="10" name="description"
                                            placeholder="Thông tin mô tả">{{ $homestay->description }}</textarea>
                                    </label>
                                </div>
                                <div class="f-item custom-item">
                                    <label>Title: </label>
