            ...
            <section class="three-fourth" style="width:100%">
                ...
                <div class="deals clearfix" >
                    ...
                    <article class="one-fourth homestay-custom" >
                        <figure><a href="{{route('list-room',['id'=>$Homestay->id])}}" title=""><img src="{{asset($Homestay->avatar)}}" alt="" width="270" height="152" /></a></figure>
                        <div class="details custom_details">
                            ...
                            <span class="price none-border">{{$Homestay->district->name}},&nbsp;{{$Homestay->province->name}}
                                <em>
                                    <img src="{{ URL::to('/') }}/partner/images/ico/gps.png" alt="" width="22" height="22" />
                                </em>
                            </span>
                            ...
                            <span class="price none-border">Thêm ảnh ({{$Homestay->image->count()}})&nbsp; &nbsp;
                                <em>
                                    <a href="{{url('partner/upload_images', ['id' => $Homestay->id])}}"><img src="{{ URL::to('/') }}/partner/images/ico/plus.png" alt="" width="22" height="22" /></a>
                                </em>
                            </span>
                            <span class="price none-border">Đánh giá ({{$Homestay->rating->count()}})&nbsp; &nbsp;
                                <em>
                                    <a href="{{route('RatingHomestay',['id'=>$Homestay->id])}}"><img src="{{ URL::to('/') }}/partner/images/ico/rating.png" alt="" width="22" height="22" /></a>
                                </em>
                            </span>
                            <span class="price" style="border: none;margin : 0 auto"><label for="">Chỉnh sửa &nbsp; &nbsp;</label>
                                <em>
                                    <a href="{{url('partner/edit-list-homestay', ['id' => $Homestay->id])}}"><img src="{{ URL::to('/') }}/partner/images/ico/edit.png" alt="" width="16" height="16" /></a>
                                </em>
                            </span>     <br>
