			...
			<div class="content clearfix">
					...
					<div class="deals clearfix">
						<!--deal-->
							...
							<article class="one-fourth">
								<figure><a href="{{url('room-detail'.'?id='.$productVal->homestay->id)}}" title=""><img src="{{asset($productVal->avatar)}}" alt="" width="270" height="152" /></a></figure>
								<div class="details">
									...
									<span class="price none-border">Thêm ảnh ({{$productVal->image->count()}})&nbsp; &nbsp;
										<em>
											<a href="{{route('UploadImageRoom',['id'=>$productVal->id])}}"><img src="{{ URL::to('/') }}/partner/images/ico/plus.png" alt="" width="22" height="22" /></a>
										</em>
									</span>
									...
									<span class="price"  style="border: none;margin : 0 auto"><label for="">Chỉnh sửa &nbsp; &nbsp;</label>
										<em>
											<a href="{{url('partner/edit-list-room', ['id' => $productVal->id])}}"><img src="{{ URL::to('/') }}/partner/images/ico/edit.png" alt="" width="16" height="16" /></a>
										</em>
									</span>
				...
				<section class="full">
					...
					<div class="deals clearfix">
						...
						<article class="one-fourth">
							<figure><a title=""><img src="{{asset($ViewRoom->avatar)}}" alt="" width="270" height="152" /></a></figure>
							<div class="details">
