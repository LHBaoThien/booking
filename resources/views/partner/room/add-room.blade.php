            ...
            <div class="content clearfix">
                ...
                <nav role="navigation" class="breadcrumbs clearfix">
                    ...
                    <ul class="crumbs">
                        ...
                        <li><a href="{{ route('list-room', ['id' => $homestay->id]) }}" title="ListRoom">Danh sách phòng</a>
                        </li>
                        <li>Thêm Homestay</li>
                    </ul>
                    <!--//crumbs-->
                ...
                <section class="three-fourth form-booking">
                    ...
                    <form id="booking" method="post" action="{{ route('addRoomPost') }}" class="booking "
                        ...
                        <fieldset>
                            ...
                            <div class="row twins">
                                <div class="f-item custom-item">
                                    ...
                                    <input type="hidden" name="homestay_id" id="homestay_id" value="{{ $homestay->id }}"
                                        readonly="readonly">
                                </div>
                                <div class="f-item custom-item">
                            ...
                            <div class="row twins">
                                <div class="f-item custom-item">
                                    ...
                                    @if ($errors->addHomestay->has('room_type_id'))
                                        <span
                                            class="notify"><i>{{ $errors->addHomestay->first('room_type_id') }}</i></span><br />
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="row twins">
                                <div class="f-item custom-item">
                                    ...
                                    @if ($errors->addHomestay->has('prices'))
                                        <span
                                            class="notify"><i>{{ $errors->addHomestay->first('prices') }}</i></span><br />
                                    @endif
                                </div>
                                <div class="f-item custom-item">
                                    ...
                                    @if ($errors->addHomestay->has('discount'))
                                        <span
                                            class="notify"><i>{{ $errors->addHomestay->first('discount') }}</i></span><br />
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="row twins">
                                ...
                                <div class="f-item custom-item">
                                    ...
                                    @if ($errors->addHomestay->has('description'))
                                        <span
                                            class="notify"><i>{{ $errors->addHomestay->first('description') }}</i></span><br />
                                    @endif
                                </div>
                                <div class="f-item custom-item">
                                    ...
                                    @if ($errors->addHomestay->has('avatar'))
                                        <span
                                            class="notify"><i>{{ $errors->addHomestay->first('avatar') }}</i></span><br />
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="row twins">
                                @foreach ($tienichs as $items)
                                    <div class="f-item custom-item checkbox">
                                        <input type="checkbox" name="tienich[]" id="{{ $items->id }}"
                                            value="{{ $items->id }}" />
