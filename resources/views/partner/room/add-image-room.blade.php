        ...
        <div class="wrap clearfix">
            ...
            <div class="content clearfix">
                ...
                <nav role="navigation" class="breadcrumbs clearfix">
                    ...
                    <ul class="crumbs">
                        ...
                        <li><a href="{{ route('list-room', ['id' => $product->homestay_id]) }}" title="ListRoom">Danh sách
                                phòng</a></li>
          ...
          <li><a href="#" title="Change search">Change search</a></li>
                ...
                <section class="three-fourth form-booking">
                    <h1 style="text-align: center;text-transform: uppercase;"> Ảnh của phòng <br><b
                            style="color: lightcoral;font-size:15px"><u>{{ $product->name }}</u></b></h1>
                    ...
                    <form id="booking" method="post" action="" class="booking ">
                        ...
                        @foreach ($product->image as $productVal)
                            ...
                            <article class="one-fourth img_custom">
                                ...
                                <div class="details">
                                    <a href="{{ route('delete_image_room', ['id' => $productVal->id]) }}"
                                        onclick="return confirm ('Bạn có muốn xóa ảnh')"><img style="float: right"
                                            src="{{ URL::to('/') }}/partner/images/ico/delete1.png" alt="" width="20"
                                            height="20" /></a>
                                </div>
                            </article>
                            <!--column-->
                        ...
                        @if (empty($product->avatar == ''))
                            <article class="one-fourth img_custom">
                                ...
                                <div class="details">
                                    <a href="{{ route('delete_avatar_room', ['id' => $product->id]) }}"
                                        onclick="return confirm ('Bạn có muốn xóa ảnh')"><img style="float: right"
                                            src="{{ URL::to('/') }}/partner/images/ico/delete1.png" alt="" width="20"
                                            height="20" /></a>
                                </div>
