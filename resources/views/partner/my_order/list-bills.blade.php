                                ...
                                @foreach ($list_Bill as $list_BillVal)
                                    ...
                                    @if ($list_BillVal->status != 0)
                                        <td class="function_one_bills">
                                            <a href="{{ route('information_order', ['id' => $list_BillVal->id]) }}"><img
                                                    src="{{ URL::to('/') }}/partner/images/ico/detail.png" alt=""
                                    ...
                                    @elseif($list_BillVal->status == 0)
                                        ...
                                        <td class="function_bills">
                                            <a href="{{ route('CancelBook', ['id' => $list_BillVal]) }}"><img src=""
                                                    alt=""><img src="{{ URL::to('/') }}/partner/images/ico/cancel.png"
                                                    alt="" width="16px" height="16px"></a>
                                        </td>
                                    @endif
                                    </tr>
                                @endforeach
