                    ...
                    <section id="MyBookings" class="tab-content tab-booking">
                        ...
                        @foreach ($order as $orderVal)
                            ...
                            <article class="bookings">
                                <h1 style="color: #ff6666;font-size:20px;text-align: center;text-transform: uppercase;">Đơn
                                    hàng thứ {{ $i }}</h1>
                                <div class="b-info">
                                    <table>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            @foreach ($product as $valPro)
                                                @if ($orderVal->product_id == $valPro->id)
                                                    <td><img style="display: inline-block;"
                                                            src="{{ asset($valPro->avatar) }}" alt="Image" width="300px"
                                                            height="150px"></td>
                                                @endif
                                            @endforeach
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            @foreach ($product as $valPro)
                                                @if ($orderVal->product_id == $valPro->id)
                                                    <td><strong>{{ number_format($valPro->prices, 0, ',', '.') }}đ</strong>
                                                    </td>
                                                @endif
                                            @endforeach
                                        </tr>
