                    ...
                    <div class="deals clearfix">
                        @foreach ($blog as $blogVal)
                            ...
                            <article class="one-fourth">
                                <figure><a
                                        href="{{ route('userBlogDetail') . '?id=' . $blogVal->id . '&title=' . $blogVal->alias }}"
                                        title=""><img src="{{ $blogVal->photo }}" alt="" width="270" height="172" /></a>
                                </figure>
                                <div class="details">
                                    <a href="{{ route('userBlogDetail') . '?id=' . $blogVal->id . '&title=' . $blogVal->alias }}"
                                        class="title">{{ $blogVal->title }}</a>
