        ...
        <div class="wrap clearfix">
                ...
                @foreach ($homestayTopRate as $homestayTopRateVal)
                    ...
                    <div class="details">
                        <div class="homestay_info">
                            <h5>{{ $homestayTopRateVal->name }}&nbsp&nbsp<span
                                    class="point">{{ $homestayTopRateVal->point }}</span>
                            </h5>
                            </span>
                        </div>
                        <div class="ribbon">
                            <div class="half hotel">
                                <a href="{{ route('userRoomDetail') . '?id=' . $homestayTopRateVal->id . $urlSearch }}"
                                    title="View all">
                                    <span class="small" style="margin-left:5px">Giá từ</span>
                                    <span class="price"
                                        style="margin-left: 10px; color: white">{{ number_format($homestayTopRateVal->product->min('prices'), 0, ',', '.') }}đ</span>
                                </a>
                            </div>
                            <div class="half flight">
                                <a href="{{ route('userRoomDetail') . '?id=' . $homestayTopRateVal->id . $urlSearch }}"
                                    title="View all">
                                    <span class="location"
                                        style="color: white">{{ $homestayTopRateVal->province->name }}</span>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <section class="destinations clearfix full">
                ...
                @foreach ($homestay as $homestayVal)
                    ...
                    <div class="details">
                        <div class="homestay_info">
                            <h5>{{ $homestayVal->name }}&nbsp&nbsp<span class="point">{{ $homestayVal->point }}</span>
                            </h5>
                        </div>
                        <div class="ribbon">
                            <div class="half hotel">
                                <a href="{{ route('userRoomDetail') . '?id=' . $homestayVal->id . $urlSearch }}"
                                    title="View all">
                                    <span class="small" style="margin-left:5px">Giá từ</span>
                                    <span class="price"
                                        style="margin-left: 10px; color: white">{{ number_format($homestayVal->product->min('prices'), 0, ',', ' ') }}đ</span>
                                </a>
                            </div>
                            <div class="half flight">
                                <a href="{{ route('userRoomDetail') . '?id=' . $homestayVal->id . $urlSearch }}"
                                    title="View all">
                                    <span class="location" style="color: white">{{ $homestayVal->province->name }}</span>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <section class="boxes clearfix icon">
                ...
                <article class="one-fourth slogan_homepage">
                    ...
                    <p>Tất cả các cuốn sách Khách sạn du lịch của bạn đáp ứng các tiêu chí lựa chọn nghiêm ngặt. Mỗi khách
                        sạn được chọn riêng và không thể mua.</p>
                </article>
                <!--//column-->
                ...
                <article class="one-fourth slogan_homepage">
                    ...
                    <p>Để cho bạn một ấn tượng chính xác về khách sạn, chúng tôi nỗ lực để xuất bản các mô tả khách sạn minh
                        bạch, cân bằng và chính xác.</p>
                </article>
                <!--//column-->
                ...
                <article class="one-fourth slogan_homepage">
                    ...
                    <p>Các chuyên gia của chúng tôi luôn cập nhật thêm về khách sạn của chúng tôi, môi trường xung quanh và
                        các hoạt động được cung cấp gần đó.</p>
                </article>
                <!--//column-->
                ...
                <article class="one-fourth slogan_homepage">
                    ...
                    <p>Đội ngũ Travels của chúng tôi sẽ phục vụ cho các yêu cầu đặc biệt của bạn. Chúng tôi cung cấp lời
                        khuyên chuyên môn để tìm đúng khách sạn.</p>
                </article>
                <!--//column-->
                ...
                <article class="one-fourth slogan_homepage">
                    ...
                    <p>Chúng tôi cung cấp các khách sạn tốt nhất với giá tốt nhất. Nếu bạn tìm thấy cùng loại phòng vào cùng
                        ngày rẻ hơn ở nơi khác, chúng tôi sẽ hoàn lại tiền chênh lệch. Đảm bảo, và nhanh chóng.</p>
                </article>
                <!--//column-->
                ...
                <article class="one-fourth slogan_homepage">
                    ...
                    <p>Đặt hệ thống đặt chỗ du lịch của bạn được bảo mật và thẻ tín dụng và thông tin cá nhân của bạn được
                        mã hóa. <br /> Chúng tôi làm việc theo tiêu chuẩn cao và đảm bảo quyền <strong>riêng tư</strong> của
                        bạn.</p>
                </article>
                <!--//column-->
                ...
                <article class="one-fourth slogan_homepage">
                    ...
                    <p>Chúng tôi cung cấp một mô hình hiệu quả về chi phí, mạng lưới hơn 5000 đối tác và dịch vụ quản lý tài
                        khoản được cá nhân hóa để giúp bạn tối ưu hóa doanh thu của mình.</p>
                </article>
                <!--//column-->
                ...
                <article class="one-fourth slogan_homepage">
                    ...
                    <p>Gọi cho chúng tôi theo số <em>0971097399</em> để được tư vấn riêng, phù hợp cho kỳ nghỉ hoàn hảo của
                        bạn hoặc gửi tin nhắn cho chúng tôi với câu hỏi đặt phòng khách sạn của bạn.<br /></p>
                </article>
                <!--//column-->
            </section>
            <!--//info boxes-->
