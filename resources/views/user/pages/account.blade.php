                                    ...
                                    <td>{{ $user->name }}&nbsp&nbsp
                                        ...
                                        <div class="edit_field" id="field1">
                                            <form action="{{ route('userEditName', ['id' => $id]) }}" method="post">
                                                ...
                                                <input type="submit" value="Cập nhật" name="editUserName"
                                    ...
                                    <td>{{ $user->email }}&nbsp&nbsp
                                        ...
                                        <div class="edit_field" id="field2">
                                            <form action="{{ route('userEditEmail', ['id' => $id]) }}" method="post">
                                                ...
                                                <input type="submit" value="Cập nhật" name="editEmail"
                                    ...
                                    <td>
                                        ...
                                        <div class="edit_field" id="field3">
                                            <form action="{{ route('userEditPassword', ['id' => $id]) }}" method="post">
                                                ...
                                                <input type="submit" value="Cập nhật" name="editPassword"
                                        ...
                                        <div class="edit_field" id="field4">
                                            <form action="{{ route('userEditPhone', ['id' => $id]) }}" method="post">
                                                ...
                                                <input type="text" id="phone" name="phone" minLength="6" maxLength="12"
                                                    required="required" />
                                                <input type="submit" value="Cập nhật" name="editPhone"
                                ...
                                <tr>
                                    ...
                                    <div class="edit_field" id="field6">
                                        <form action="{{ route('userEditAddress', ['id' => $id]) }}" method="post">
                                            ...
                                            <br />
                                            <input type="submit" value="Cập nhật" name="editAddress" class="gradient-button"
                                                id="editAddress" />
                                        </form>
                                    </div>
                                    <!--//edit fields-->
                                ...
                                <div class="b-info">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>{{ number_format($billBookingVal->payments, 0, ',', '.') }}đ</strong>
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <article class="bookings">
                                ...
                                <div class="b-info">
                                    <table>
                                        ...
                                        <tr>
                                            <th>Tổng tiền thanh toán</th>
                                            <td><strong>{{ number_format($billHistoryVal->payments, 0, ',', '.') }}đ</strong>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Trạng thái đặt phòng</th>
