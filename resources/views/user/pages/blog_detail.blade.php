                ...
                <section class="three-fourth">
                    <div class="post-header">
                        ...
                        <div class="post-infor">
                            ...
                            <p class="post-date" style="display:inline">
                                {{ date('d-m-Y', strtotime($blogDetailVal->created_at)) }}</p>
                        </div>
                    </div>
                            ...
                            @foreach ($homestaySuggest as $homestaySuggestVal)
                                <div class="deal-of-the-day">
                                    <a href="{{ route('userRoomDetail') . '?id=' . $homestaySuggestVal->id . $urlSearch }}">
                                        <figure><img src="{{ $homestaySuggestVal->avatar }}" alt="" width="230"
                                                height="130" /></figure>
                                        ...
                                        <p>Từ <span
                                                class="price">{{ number_format($homestaySuggestVal->product->min('prices'), 0, ',', '.') }}<small>/đêm</small></span>
                                        </p>
                                    </a>
                                </div>
                            @endforeach
                            <br /><br />
                            <a href="{{ route('userSearch') . '?address=' . $homestaySuggestVal->province->name . $urlSearch }}"
                                title="Show all" class="show-all">Show all</a>
                        </article>
                        <!--//Homestay suggest-->
                    @endif
                    <!--Ads-->
