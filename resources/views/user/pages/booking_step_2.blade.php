                ...
                <section class="three-fourth">
                    <form id="booking" method="post" action="user_booking_step_3.html" class="booking">
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="f-item">
                                    <h5>Chúng tôi đã gửi mã xác nhận đến email của bạn( Nếu không phát hiện email, hãy kiểm
                                        tra trong hộp thư <strong>spam</strong>)</h5><br />
                                </div>
                            </div>
                            <div class="row">
                                <div class="f-item">
                                    <p>Nếu vẫn không nhận được email xác thực, hãy nhấp vào <strong>Gửi lại</strong> bên
                                        dưới </p>
                                </div>
                            </div>
