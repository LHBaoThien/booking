                    ...
                    <div class="lb-content">
                        <form action="{{ Route('registerUser') }}" method="post">
                            ...
                            <div class="f-item">
                                ...
                                <input type="text" id="phoneRegister" name="phone" minLength="6" maxLength="12"
                                    required="required" />
                            ...
                            <div class="input-pass f-item">
                                ...
                                <input type="password" id="password" class="show" name="password" minLength="8"
                            ...
                            <div class="input-pass f-item">
                                ...
                                <input type="password" id="confirm_password" class="show" name="confirm_password"
                                    required="required" />
                                <input type="button" class="btnShow" value="show" id="showPassword">
                                @if ($errors->register->has('confirm_password'))
                                    <span
                                        class="feedback">{{ $errors->register->first('confirm_password') }}</span><br />
                                @endif
                            </div>
        ...
        <label for="newsletter">Thông báo cho tôi những ưu đãi độc quyền</label>
                            ...
                            <p style="color: rgba(56, 209, 255, 0.86);">Hãy nhấn <span style="color: aliceblue;">"Đăng
                                    ký"</span> nếu bạn đã đọc và đông ý với <a href="{{ route('userConditions') }}">Điều
                                    khoản dịch vụ</a> và <a href="{{ route('userConditions') }}">Chính sách bảo mật</a>
                                của chúng tôi. </p>
