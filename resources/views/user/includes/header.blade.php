<header>
		<div class="wrap clearfix">
			<!--logo-->
			<h1 class="logo"><a href="../" title="Himinn Booking - Home"><img src="user/images/txt/logo.png" alt="Himinn Booking" /></a></h1>
			<!--//logo-->
			...
			<div class="ribbon">
				...
				@if( Auth::check() && Auth::user()->permision == 2)
					<ul class="profile-nav">
						...
						?>
						<li class="active" id="static"><a class="no-href" title="Thông tin">Chào! <br/>{{$last_name}}</a></li>
						<li class=""><a class="li_list" href="{{route('userAccount',['id' => Auth::user()->id])}}" title="My Account">Thông tin</a></li>
				...
				@endif
					<ul class="currency-nav">
						<li class="active"><a href="{{url('/partner/login-partner')}}" target="_blank" title="Bạn muốn hợp tác với chúng tôi?">Đối tác</a></li>
					</ul>
				</nav>
			</div>
			<!--//ribbon-->
