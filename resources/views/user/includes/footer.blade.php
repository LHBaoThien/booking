<footer>
    <div class="wrap clearfix">
        ...
        <article class="one-fourth">
            ...
            <p><em>Email:</em><a href="mailto:himinnbooking@gmail.com" title="himinnbooking@gmail.com">
                    himinnbooking@gmail.com</a></p>
        </article>
        <!--//column-->
        ...
        <article class="one-fourth">
            ...
            <ul>
                <li><a href="{{ route('userConditions') }}" title="Điều khoản và điều kiện">Điều khoản và điều kiện</a>
                </li>
        ...
        <article class="one-fourth">
            ...
            <fieldset>
                ...
                <input type="submit" id="signUp" name="signUp" value="Đăng ký" onclick="singUp()"
