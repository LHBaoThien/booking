...
@section('content')
    ...
    <div id="content" class="span10">
        <ul class="breadcrumb">
            ...
            <li>
                <i class="icon-angle-right"></i>
                <a href="{{ url('/admin/homestay/DSroomstyle') }}">Danh sách kiểu phòng</a>
            </li>
        </ul>
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header" data-original-title>
                    <h2><i class="halflings-icon white user"></i><span class="break"></span>Danh sách kiểu phòng</h2>
                    <div class="box-icon">
                            ...
                            @foreach ($DSRS as $tl)
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        @if ($tl->status == 1)
                                            <p class="label label-important">Hiện</p>
                                        @else
                                            <p class="label label-primary">Ẩn</p>
                                        @endif
                                    </td>
                                    <td style="text-align: center">
                                        <a href="{{ url('/admin/homestay/xoaRS') }}/{{ $tl->id }}"
                                            class="btn btn-success" onclick="return confirm('Bạn Muốn Xóa?');">Xóa</a>
