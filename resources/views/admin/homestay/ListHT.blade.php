...
@section('content')
    ...
    <div id="content" class="span10">
        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header" data-original-title>
                    <h2><i class="halflings-icon white user"></i><span class="break"></span>Danh sách khách sạn</h2>
                    <div class="box-icon">
                        ...
                        <tbody>
                            @foreach ($homestay as $tl)
                                <tr>
                                    ...
                                    <td style="text-align: center"><img width="80px"
                                            src="{{ URL::to('/') }}/{{ $tl->avatar }}" alt=""></td>
                                    ...
                                    <td style="text-align: center">
                                        <a href="{{ url('/admin/homestay/products') }}/{{ $tl->id }}"
                                            class="btn btn-success">List</a>
                                        <a class="btn btn-primary"
                                            href="{{ url('/admin/homestay/edit') }}/{{ $tl->id }}">
        ...
        <a class="btn btn-primary" href="{{ url('/admin/homestay/DStienich') }}">Tiện ích</a>
        <a class="btn btn-primary" href="{{ url('/admin/homestay/DSroomstyle') }}">Kiểu phòng</a>
    </div>
@endsection
