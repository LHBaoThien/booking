        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header" data-original-title>
                    <h2><i class="halflings-icon white edit"></i><span class="break"></span>Detail : {{ $user->name }}
                    </h2>
                    <div class="box-icon">
                    ...
                    <form class="form-horizontal">
                        <fieldset>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <img style="border-radius: 50%;width: 70px;height: 70px; padding-top: 3px;"
                                        src="{{ URL::to('/') }}/{{ $user->avatar }}" alt="">
                                </div>
                            </div>
                            <div class="control-group">
