                                ...
                                @if ($tl->permision == 0)
                                    <tr>
                                        <td style="text-align: center"><img
                                                style="border-radius: 50%;width: 50px;height: 50px; padding-top: 3px;"
                                        ...
                                        <td>
                                            @if (Auth::user()->id == $tl->id)
                                                <a href="{{ url('/admin/khachhang/detail') }}/{{ $tl->id }}"
                                                    class="btn btn-primary">Detail</a>
                                                <a href="{{ url('admin/khachhang/edit') }}/{{ $tl->id }}"
                                            ...
                                            @else
                                                ...
                                                <a class="btn btn-danger"
                                                    href="{{ url('admin/khachhang/delete') }}/{{ $tl->id }} "
                                                    onclick="return confirm('Bạn Muốn Xóa Đối Tượng?');">
                    ...
                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        <tbody>
                            @foreach ($user as $tl)
                                @if ($tl->permision == 1)
                                    <tr>
                                        <td style="text-align: center"><img width="60px"
                                                src="{{ URL::to('/') }}/{{ $tl->avatar }}" alt=""></td>
                                        <td>{{ $tl->name }}</td>
                                        <td>{{ $tl->created_at }}</td>
                                        <td>{{ $tl->email }}</td>
