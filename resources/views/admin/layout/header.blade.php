<div class="navbar">
    <div class="navbar-inner">
        <div class="container-fluid">
            <div class="brand">
                <img style="border-radius: 50%;width: 50px;height: 50px; padding-top: 3px;"
                ...
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="{{ url('/admin/khachhang/detail') }}/{{ Auth::user()->id }}"><i
                                        class="halflings-icon user"></i> Profile</a></li>
