        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header" data-original-title>
                    <h2><i class="halflings-icon white edit"></i><span class="break"></span>Edit Slide: {{ $slide->id }}
                    </h2>
                    <div class="box-icon">
                ...
                <div class="box-content">
                    ...
                    @endif
                    <form class="form-horizontal" action="{{ url('/admin/QLSlide/edit') }}/{{ $slide->id }}"
                        ...
                        <fieldset>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <img width="180px" height="160px" src="{{ URL::to('/') }}/{{ $slide->url }}"
                                        alt="">
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <select name="order" id="order">
                                        @foreach ($sli as $tl)
                                            <option value="{{ $tl->order }}" @if ($tl->order == $slide->order) selected="selected"; @endif>
                                                Vị trí số: {{ $tl->order }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="control-group">
                                ...
                                <label class="controls radio-inline">
                                    <input type="radio" name="status" value="0" id="status" @if ($slide->status == 0) {{ 'checked' }} @endif>Ẩn
                                </label>
                                <label class="controls radio-inline">
                                    <input type="radio" name="status" value="1" id="status" @if ($slide->status == 1) {{ 'checked' }} @endif>Hiện
                                </label>
                            </div>
