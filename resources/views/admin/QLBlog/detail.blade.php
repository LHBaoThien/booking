                    ...
                    <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <img width="120px" src="{{ URL::to('/') }}/{{ $blog->photo }}" alt="">
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <label class="controls radio-inline">
                                    <input type="radio" name="status" value="0" id="status" @if ($blog->status == 0) {{ 'checked' }} @endif>Ko
                                </label>
                                <label class="controls radio-inline">
                                    <input type="radio" name="status" value="1" id="status" @if ($blog->status == 1) {{ 'checked' }} @endif>Có
                                </label>
                            </div>
