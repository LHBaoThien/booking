        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header" data-original-title>
                    <h2><i class="halflings-icon white edit"></i><span class="break"></span>Edit ID: {{ $blog->id }}
                    </h2>
                    <div class="box-icon">
                    ...
                    <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input style="width: 500px; height: 30px;" type="text" id="description"
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <br>
                                    <img width="180px" height="170px" src="{{ URL::to('/') }}/{{ $blog->photo }}"
                                        alt="">
                                </div>
                            </div>
                                ...
                                <div class="controls">
                                    <select name="maqh" id="maqh">
                                        @foreach ($district as $tl)
                                            <option value="{{ $tl->maqh }}" @if ($blog->maqh == $tl->maqh) selected="selected" @endif>
                                                {{ $tl->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="control-group">
                                ...
                                <label class="controls radio-inline">
                                    <input type="radio" name="status" value="0" id="status" @if ($blog->status == 0) {{ 'checked' }} @endif>Ẩn
                                </label>
                                <label class="controls radio-inline">
                                    <input type="radio" name="status" value="1" id="status" @if ($blog->status == 1) {{ 'checked' }} @endif>Public
                                </label>
                            </div>
